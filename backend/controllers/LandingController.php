...
class LandingController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
			...
			$contenido .= $model->codigo;
            $banner = "<div class='nk-cookie-banner alert alert-warning text-center mb-0' role='alert' style='background: background: #EA0605;'> Nous utilisons nos propres cookies et ceux de tiers, à la fois persistants et de session, pour des raisons techniques de personnalisation, d'analyse, de publicité et pour partager du contenu sur les réseaux sociaux et générer des informations de profil spécifiques en fonction des préférences de navigation de l'utilisateur. Si vous acceptez l'installation de cookies ou continuez à naviguer, nous considérons que vous acceptez leur utilisation. <a href='#cookiesModal'>Plus d'informations</a> <button type='button' class='btn btn-primary btn-sm ml-3' onclick='window.nk_hideCookieBanner()''> J'ACCEPTE </button> </div>"; 
