<?php 
	...
	$sql = "INSERT INTO emails (nombre, apellido, telefono, email, direccion, idLanding,fecha,fnacimiento,opciones, ciudad, codp)
	...
	$fnacimiento."','".$opciones."', '".htmlspecialchars($_POST['ciudad'])."', '".htmlspecialchars($_POST['codP'])."')";
